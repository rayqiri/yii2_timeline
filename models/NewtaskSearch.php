...
/**
 * NewtaskSearch represents the model behind the search form about `app\models\Newtask`.
 */
class NewtaskSearch extends Newtask
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['task', 'duein', 'importance', 'clarity', 'effort'], 'safe'],
        ];
    }
